...
INT8U Inn_WriteBit(INT16U DevNumber,char *DevName,U8 Value)
{
	...
	{
		switch(DevNumber)
		{  //////模式选择互锁g_InteralMemory.KeepBit[]/////////////
		   case 11:
		   {g_InteralMemory.KeepBit[12]=0;};break;
		   case 12:
		   {g_InteralMemory.KeepBit[11]=0;};break;
		   case 13:
		   {g_InteralMemory.KeepBit[15]=0;};break;
		   case 15:
		   {g_InteralMemory.KeepBit[13]=0;};break;
