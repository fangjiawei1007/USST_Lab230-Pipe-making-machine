...
void DisplaySystemScr(INT8U State)
{
	...
	if(State == 0)
	{
		Lcd_Clr(6);	
		//Lcd_Clr(BLUE);	
		Lcd_Fill_Box (0, 0, 640,68, 13);
		//Lcd_Fill_Box (0, 0, 640,68, GREEN); //Red,top
		Lcd_DispHZ_On_Button(200,10,440,40,4,3,13,3,0,1,0,0,Info);
		//Lcd_DispHZ_On_Button(200,10,440,40, 4,BLACK,GREEN,3, 0,1,0,0, Info);

		Lcd_Fill_Box (0, 425, 640,480, 13);
		//Lcd_Fill_Box (0, 425, 640,480, GREEN);
		Lcd_DispAsc_On_Button(0, 425, 639, 479, strlen(Str),13,3,4,2,0,Str);
	...
	{
		Lcd_Button(Left,Top,Left+90,Top+60,7,3,INSERT);
		//Lcd_Button(Left,Top,Left+90,Top+60,GREEN,3,INSERT);
		Lcd_DispHZ_On_Button(Left, Top, Left+90, Top+60,2, 0, 7,2,0,0,0,3,XiaZai);
		//Lcd_DispHZ_On_Button(Left, Top, Left+90, Top+60, 2, BLACK, GREEN,2,0,0,0,3,XiaZai);
	}
	else
	{
		Lcd_Button(Left,Top,Left+90,Top+60,7,3,RAISE);
	...
	if((State == 1) && ((X_result>260&&X_result<350) && (Y_result>140&&Y_result<200)))
	{
		Lcd_Button(Left,Top,Left+90,Top+60,7,3,INSERT);
		//Lcd_Button(Left,Top,Left+90,Top+60,GREEN,3,INSERT);
		Lcd_DispHZ_On_Button(Left, Top, Left+90, Top+60,3, 0, 7,2,0,0,0,3,ShangZai);
	...
	if((State == 1) && ((X_result>455&&X_result<455+90) && (Y_result>140&&Y_result<200)))
	{
		Lcd_Button(Left,Top,Left+90,Top+60,7,3,INSERT);
		//Lcd_Button(Left,Top,Left+90,Top+60,GREEN,3,INSERT);
		Lcd_DispHZ_On_Button(Left,Top, Left+90, Top+60,2, 0, 7,2,0,0,0,3,YunXing);
	...
	{
		Lcd_Button(Left,Top,Left+140,Top+80,7,3,INSERT);
		//Lcd_Button(Left,Top,Left+140,Top+80,GREEN,3,INSERT);
		Lcd_DispHZ_On_Button(Left,Top, Left+140, Top+80,4, 0, 7,2,0,0,0,3,CanShuSheZhe);
		//Lcd_DispHZ_On_Button(Left,Top, Left+140, Top+80,4, BLACK, GREEN,2,0,0,0,3,CanShuSheZhe);
	} 
	else
	{
		Lcd_Button(Left,Top,Left+140,Top+80,7,3,RAISE);
	...
	if((State == 1) && ((X_result>235&&X_result<235+140) && (Y_result>270&&Y_result<270+80)))
	{
		Lcd_Button(Left,Top,Left+140,Top+80,7,3,INSERT);
		//Lcd_Button(Left,Top,Left+140,Top+80,GREEN,3,INSERT);
		Lcd_DispHZ_On_Button(Left,Top, Left+140, Top+80,4, 0, 7,2,0,0,0,3,JiDianJiaoZhun);
	...
	if((State == 1) && ((X_result>430&&X_result<430+140) && (Y_result>270&&Y_result<270+80)))
	{
		Lcd_Button(Left,Top,Left+140,Top+80,7,3,INSERT);
		//Lcd_Button(Left,Top,Left+140,Top+80,GREEN,3,INSERT);
		Lcd_DispHZ_On_Button(Left,Top, Left+140, Top+80,4, 0, 7,2,0,0,0,3,HuaMianJianCha);
